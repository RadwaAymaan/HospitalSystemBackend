...
public class ItemCategoryCategoryServiceTest
{
    ...
    public async Task AddItemCategory(string ItemCategoryName)
    {
        ...
        // Act
        var result = await _itemCategoryService.AddCategoryAsync(ItemCategoryRequestDto);
    ...
    public async Task UpdateItemCategoryAsync(int id, string ItemCategoryName, bool expectedResult)
    {
        ...
        var ItemCategoryRequestDto = new ItemCategoryRequestDto {CategoryName = ItemCategoryName };
        // Act
        var result = await _itemCategoryService.UpdateCategoryAsync(id, ItemCategoryRequestDto);
        // Assert
        if (expectedResult)
        {
    ...
    public async Task GetAllItemCategory()
    {
        ...
        // Act
        var result = await _itemCategoryService.GetAllCategoriesAsync();
    ...
    public async Task GetByIdItemCategory(int id)
    {
        ...
        // Act
        var result = await _itemCategoryService.GetCategoryByIdAsync(id);
    ...
    public async Task RemoveItemCategory(int id)
    {
        ...
        // Act
        var result = await _itemCategoryService.DeleteCategoryAsync(id);
