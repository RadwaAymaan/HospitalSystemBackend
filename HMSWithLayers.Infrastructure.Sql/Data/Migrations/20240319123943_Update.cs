        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MedicineName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    MedicineDescription = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    MedicineDosage = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfPatient = table.Column<int>(type: "int", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SpecializationName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Laboratorists_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomNurses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomNurses_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomNurses_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DoctorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    LaboratoristId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalTestOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalTestOrders_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MedicalTestOrders_Laboratorists_LaboratoristId",
                        column: x => x.LaboratoristId,
                        principalTable: "Laboratorists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MedicalTestOrders_MedicalTests_MedicalTestId",
                        column: x => x.MedicalTestId,
                        principalTable: "MedicalTests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MedicalTestOrders_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResultDescription = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    ResultDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MedicalTestOrderId = table.Column<int>(type: "int", nullable: false),
                    LaboratoristId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalTestResults_Laboratorists_LaboratoristId",
                        column: x => x.LaboratoristId,
                        principalTable: "Laboratorists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalTestResults_MedicalTestOrders_MedicalTestOrderId",
                        column: x => x.MedicalTestOrderId,
                        principalTable: "MedicalTestOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestOrders_DoctorId",
                table: "MedicalTestOrders",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestOrders_LaboratoristId",
                table: "MedicalTestOrders",
                column: "LaboratoristId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestOrders_MedicalTestId",
                table: "MedicalTestOrders",
                column: "MedicalTestId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestOrders_PatientId",
                table: "MedicalTestOrders",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestResults_LaboratoristId",
                table: "MedicalTestResults",
                column: "LaboratoristId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalTestResults_MedicalTestOrderId",
                table: "MedicalTestResults",
                column: "MedicalTestOrderId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomNurses_NurseId",
                table: "RoomNurses",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomNurses_RoomId",
                table: "RoomNurses",
                column: "RoomId");
