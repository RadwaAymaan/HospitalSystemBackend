...
import { AddMedicalTestOrder, getPatient } from "api/medicalTestOrder";
...
export default function AddMedicalTestOrders(){
    const [medicalTests, setMedicalTest] = useState<ILabTest[]>([]);
    const [scanTests, setScanTest] = useState<IScanTest[]>([]);
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
      ...
      const handleSubmit = async () => {
        setMessage(await AddMedicalTestOrder(formData));
    }
    ...
    >
        ...
        >
          ...
          <Select
            placeholder="Select MedicalTest"
            onChange={handleChange}
            name="medicalTestId"
            mb="24px"
            size="lg"
