...
export default function roomTypeDetails({params}: {params: {id: number}}) {
    const [formData, setFormData] = useState<IRoomType>({});
    ...
    useEffect(() => {
        const fetchroomType = async () => {
            setFormData(await GetRoomTypeById (params.id))
        }
        fetchroomType();
    }, []);
