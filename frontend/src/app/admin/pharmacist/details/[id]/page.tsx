...
import { getPharmacistById } from "api/pharmacist";
import { IPharmacist } from "interfaces/IPharmacist";
import Link from "next/link";
import React from "react";
import { useEffect, useState } from "react";
export default function pharmacistDetails({params}: {params: {id: string}}) {
    const [formData, setFormData] = useState<IPharmacist>({});
    ...
    useEffect(() => {
        const fetchItem = async () => {
            setFormData(await getPharmacistById(params.id))
        }
        fetchItem();
    }, []);
          ...
          <FormControl>
            ...
            >
              ...
              <Input
                ...
                placeholder="pharmacistPhoneNumber"
                disabled
              />
            <FormLabel
              ms="4px"
